...
-------------------------------------------------------------------------------------------
Next we have the HomePage.js component (Main component of the homepage)
It depends on:
1) Header
2) MainSection
3) Footer
...
-------------------------------------------------------------------------------------------
Finally, we have the SignupPage.js component
It depends on:
1) Header
2) RegForm
3) Footer
...
RegForm depends on:
1) RegMessage (this depends on DisplayMessage as well to render the display message)
-------------------------------------------------------------------------------------------
...
This command should only be run if you have trouble compiling our program. It has been tested and 
proven to work.
